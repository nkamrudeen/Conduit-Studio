...
- generic [ref=e3]:
  ...
  - generic [ref=e37]:
    ...
    - generic [ref=e165]:
      - generic [ref=e166]:
        - textbox [ref=e167]: Iris Classification Pipeline
        - generic [ref=e168]: 8 nodes · 9 edges
        - generic [ref=e169]:
            ...
            - generic [ref=e196]:
              - generic:
                - generic:
                  ...
                  - img:
                    - group "Edge from node-split to node-train-rf" [ref=e197] [cursor=pointer]
                  - img:
                    - group "Edge from node-split to node-evaluate"
                  - img:
                    - group "Edge from node-train-rf to node-evaluate" [ref=e200] [cursor=pointer]
                  - img:
                    - group "Edge from node-train-rf to node-mlflow" [ref=e203] [cursor=pointer]
                  - img:
                    - group "Edge from node-evaluate to node-mlflow" [ref=e206] [cursor=pointer]
                  - img:
                ...
                - generic:
                  - group [ref=e209]:
                    - generic [ref=e210]:
                      - generic [ref=e211]:
                        - generic [ref=e212]: 📄
                        - generic [ref=e213]: CSV File
                      - paragraph [ref=e215]: Load a CSV file into a DataFrame
                      - generic [ref=e216]: DataFrame →
                      - generic "DataFrame (DataFrame)" [ref=e217]
                  - group [ref=e218]:
                    - generic [ref=e219]:
                      - generic "DataFrame (DataFrame)" [ref=e220]
                      - generic [ref=e221]:
                        - generic [ref=e222]: 🕳️
                        - generic [ref=e223]: Missing Values
                      - generic [ref=e224]:
                        - generic [ref=e225]: ← DataFrame
                        - paragraph [ref=e226]: Handle missing / null values
                      - generic [ref=e227]: DataFrame →
                      - generic "DataFrame (DataFrame)" [ref=e228]
                  - group [ref=e229]:
                    - generic [ref=e230]:
                      - generic "DataFrame (DataFrame)" [ref=e231]
                      - generic [ref=e232]:
                        - generic [ref=e233]: ✂️
                        - generic [ref=e234]: Train / Test Split
                      - generic [ref=e235]:
                        - generic [ref=e236]: ← DataFrame
                        - paragraph [ref=e237]: Split DataFrame into train and test sets
                      - generic [ref=e238]: Train DataFrame →
                      - generic [ref=e239]: Test DataFrame →
                      - generic "Train DataFrame (DataFrame)" [ref=e240]
                      - generic "Test DataFrame (DataFrame)" [ref=e241]
                  - group [ref=e242]:
                    - generic [ref=e243]:
                      - generic "Train DataFrame (DataFrame)" [ref=e244]
                      - generic [ref=e245]:
                        - generic [ref=e246]: 🌲
                        - generic [ref=e247]: Random Forest
                      - generic [ref=e248]:
                        - generic [ref=e249]: ← Train DataFrame
                        - paragraph [ref=e250]: scikit-learn RandomForestClassifier / Regressor
                      - generic [ref=e251]: Trained Model →
                      - generic "Trained Model (Model)" [ref=e252]
                  - group [ref=e253]:
                    - generic [ref=e254]:
                      - generic "Model (Model)" [ref=e255]
                      - generic "Test DataFrame (DataFrame)" [ref=e256]
                      - generic [ref=e257]:
                        - generic [ref=e258]: 📋
                        - generic [ref=e259]: Classification Report
                      - generic [ref=e260]:
                        - generic [ref=e261]: ← Model
                        - generic [ref=e262]: ← Test DataFrame
                        - paragraph [ref=e263]: Accuracy, precision, recall, F1, confusion matrix
                      - generic [ref=e264]: Metrics →
                      - generic "Metrics (Metrics)" [ref=e265]
                  - group [ref=e266]:
                    - generic [ref=e267]:
                      - generic "Trained Model (Model)" [ref=e268]
                      - generic "Metrics (Metrics)" [ref=e269]
                      - generic [ref=e270]:
                        - generic [ref=e271]: 📦
                        - generic [ref=e272]: MLflow Registry
                      - generic [ref=e273]:
                        - generic [ref=e274]: ← Trained Model
                        - generic [ref=e275]: ← Metrics
                        - paragraph [ref=e276]: Log and register the model to MLflow
                  - group [ref=e277]:
                    - generic [ref=e278]:
                      - generic "Reference DataFrame (DataFrame)" [ref=e279]
                      - generic "Current DataFrame (DataFrame)" [ref=e280]
                      - generic [ref=e281]:
                        - generic [ref=e282]: 📡
                        - generic [ref=e283]: Data Drift (Evidently)
                      - generic [ref=e284]:
                        - generic [ref=e285]: ← Reference DataFrame
                        - generic [ref=e286]: ← Current DataFrame
                        - paragraph [ref=e287]: Detect data drift between reference and current datasets
                      - generic [ref=e288]: Drift Metrics →
                      - generic "Drift Metrics (Metrics)" [ref=e289]
                  - group [ref=e290]:
                    - generic [ref=e291]:
                      - generic "DataFrame (DataFrame)" [ref=e292]
                      - generic [ref=e293]:
                        - generic [ref=e294]: 📐
                        - generic [ref=e295]: Feature Scaler
                      - generic [ref=e296]:
                        - generic [ref=e297]: ← DataFrame
                        - paragraph [ref=e298]: Scale numeric features (MinMax, Standard, Robust)
                      - generic [ref=e299]: DataFrame →
                      - generic "DataFrame (DataFrame)" [ref=e300]
            - img
            - generic "Control Panel" [ref=e301]:
              - button "Zoom In" [ref=e302] [cursor=pointer]:
                - img [ref=e303]
              - button "Zoom Out" [disabled]:
                - img
              - button "Fit View" [ref=e305] [cursor=pointer]:
                - img [ref=e306]
              - button "Toggle Interactivity" [ref=e308] [cursor=pointer]:
                - img [ref=e309]
            - img "Mini Map" [ref=e312]
    - complementary [ref=e322]:
      - paragraph [ref=e323]: Select a node to configure it
```